const putumayoTemplate = `
    <div class="template">
        <section class="template__section">
            <p class="template__text">En Harvard, Schultes fue a Colombia por primera ocasión en averiguación de los venenos usados en las flechas nativos, que después se considerarían relajantes musculares en los métodos quirúrgicos. Una vez que el adolescente etnobotánico ingresó a la selva amazónica por primera ocasión, se observó inmerso en un mundo extraordinario de chamanes y plantas sagradas.</p>
            
            <p class="template__text">Mi interacción personal con la promesa de la conservación etnobotánica inició en 1941, a lo largo de mi primer viaje a la cuenca del Amazonas. Una, como maestro de biología en una escuela privada de Nueva Inglaterra, y la otra era una beca de 10 meses del Consejo Nacional de Indagación para ir a la zona amazónica con la intención de detectar las plantas usadas en las numerosas clases de curare que los indios utilizan para cazar.</p>

            <h2 class="template__title">A través de la puerta esmeralda</h2>
        </section>

        <section class="template__section">
            <h2 class="template__title">Sus primeros años de exploraciones</h2>

            <p class="template__text">En septiembre de 1941, Richard Evans Schultes, de veintiséis años, alcanzó Bogotá, Colombia, por primera ocasión.</p>

            <figure class="template__figure">
                <img src="" alt="Rail of Bogotá image" class="template__img" id="railOfBogota">
            ...
            <figure class="template__figure template--moreWidth">
                ...
                <span class="template__description">Ilustración botánica de Pachyphyllum schultesii (Williams, 1941, p. 16)</span>
            </figure>

            <figure class="template__figure template--moreWidth">
                <img src="" alt="Illustration of Pachyphyllum Schultesii" class="template__img" id="illustrationOfPachyphyllumSchultesii">
                
                <span class="template__description">Tranvía de Bogotá, 1941 (Mankoff, A. <a href="http://www.tramz.com/co/bg/t/te.html" class="template__link">aqui</a> )</span>
            </figure>

            <p class="template__text">Luego de una breve estadía en Bogotá y un veloz viaje al norte del departamento de Santander, Schultes abordó un ferrocarril con destino a Neiva, una pequeña urbe andina al sur de Colombia. Dejando Neiva, Schultes se dirigió al oeste por medio de los Andes hasta Popayán, y después continuó hacia el sur hasta Pasto, una localidad ubicada al pie del imponente volcán Galeras. A partir de Pasto, Schultes prosiguió por una sinuosa carretera de montaña hacia el este hasta las cabeceras del flujo de agua Putumayo, su área objetivo del análisis.</p>
            
            <p class="template__text">El flujo de agua Putumayo es un fundamental afluente amazónico que empieza en los imponentes Andes del sur de Colombia y después fluye hacia el oriente por medio de verdes bosques tropicales, cruzando la línea ecuatorial alrededor de a mitad de su recorrido previo a desembocar en el flujo de agua Solimões (como se denomina el Amazonas en Brasil), 1.200 km al norte del bullicioso puerto fluvial de Manaos. El Putumayo es el exclusivo flujo de agua navegable del sur de Colombia y forma la frontera universal entre Colombia, Ecuador y Perú en parte importante de su expansión.</p>
        </section>

        <section class="template__section">
            <h2 class="template__title">Los páramos del valle de Sibundoy</h2>

            <p class="template__text">El punto de ingreso de Schultes al Putumayo ha sido el valle de Sibundoy, una depresión a modo de tazón a 2.200 metros sobre el grado del océano en el extremo de los Andes del sur de Colombia. El valle plano y más o menos circular está rodeado de montañas escarpadas por todos lados, y en la mayoría de los casos está cubierto de nubes e inundado por las fuertes lluvias que se canalizan hacia el valle, conformando las cabeceras del flujo de agua Putumayo.</p>

            <p class="template__text">Schultes alcanzó Sibundoy en el último mes del año de 1941. Partiendo de la Tarea Católica, deambulaba por las montañas en el lado noreste del valle, trepando por parches de bosques de árboles bajos y nudosos cargados con muchas especies de musgos, orquídeas, helechos y bromelias epífitas. La espesa vegetación otorgó paso a un ecosistema de praderas húmedas y azotadas por el aire, dominado por pastos y arbustos bajos.</p>

            <figure class="template__figure">
                <img src="" alt="Paramo ecosystem outside the Sibundoy valley image" class="template__img" id="paramoEcosystemOutsideTheSibundoyValley">
            ...
            <p class="template__text">Sibundoy se encuentra en el trozo más ceñido de los Andes, que cicatriz la lejanía más reducida entre la colina tropical del Amazonas y el piélago Pacífico. El ámbito relativamente natural y el receptivo cañada habrían argumento de Sibundoy una recorrido comercial llano de las culturas antiguas que se sabe han participado en una compleja enrejado comercial de naciente a poniente y todavía al sur en la altiplano Carchi del Ecuador.</p>

            <p class="template__text">Se cree que Sibundoy ha servido como un desvío de caminos y fortificación de vegetación: cabal a que antiguos viajeros llevaron variedades raras de vegetación y semillas, las especies consideradas de arrojo medicinal por las tribus de Sibundoy se guardaron y se propagaron. Como Schultes diligente descubriría, estos factores sociales y ecológicos dieron a Sibundoy la decano concurrencia de vegetación psicoactivas en América del Sur, y probablemente en el mundo.</p>
        </section>

        <section class="template__section">
            <h2 class="template__title">Los ingas y kamentsás del valle de Sibundoy”</h2>

            <p class="template__text">Dos grupos étnicos indígenas viven en Valle de Sibundoy: el inga y el kamentsá. Los segundo grupos hablan idiomas diferentes y tienen diferentes historias de su mitología y origen, sin embargo tiene importantes similitudes en términos culturales, de gobierno social, expresión de vida, formas de firmeza y ilusión del mundo.</p>

            <figure class="template__figure">
                <img src="" alt="Inga near to Aponte" class="template__img" id="ingaNearTo">
            ...
            <p class="template__text">A finales del siglo XVII, dirigidos por el carismático dueño Carlos Tamoabioy, los ingas y kamentsá crearon una unifamiliar política que perdura inclusive nuestros días. En mérito de esta unifamiliar, el municipio inga-kamentsá se define por las altas cumbres de todo el valle: Patascoy, Bordoncillo, Aponte, Juanoy y Portachuelo.</p>

            <figure class="template__figure template--wholeWidth">
                <img src="" alt="Salvador Chindoy" class="template__img" id="salvadorChindoy">
                
                <span class="template__description">Salvador Chindoy, un chamán kamentsá que compartió gran parte de su conocimiento etnobotánico con Schultesk</span>
            </figure>
            ...
            <p class="template__text">Pedro Juajibioy, un mozo centinela de la clan kamentsá, trabajó estrechamente con Chindoy (como inexperto) y con Schultes (como manual y traductor). Muy influenciado por los misioneros capuchinos en su juventud, Pedro inicialmente fue un evangélico honrado que descubrió el prerrogativa de las vegetación a través de sus viajes con Chindoy y Schultes y, finalmente, se convirtió en un insigne fitógrafo y curandero, adoptando creencias y prácticas tradicionales.</p>
            
            <figure class="template__figure">
                <img src="" alt="Un joven de kamentsá en el páramo de Tambillo, 1941" class="template__img" id="aYoungKamentsáBoy">
...
main.id = 'putumayoTemplate';
main.innerHTML = putumayoTemplate;
